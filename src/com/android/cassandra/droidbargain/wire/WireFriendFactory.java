...
public class WireFriendFactory implements Comparable<WireFactory>, WireFactory {
	...
	public WireFriendFactory(String pElement1, String pElement2, String pWireType, String pTimestamp){
		element1 = pElement1;
		element2 = pElement2;
		wireType = pWireType;
